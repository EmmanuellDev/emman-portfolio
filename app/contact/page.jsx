...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+91) 9994873204",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "emmanuelsk04@gmail.com",
  },
  {
    icon: <FaMapMarkedAlt />,
    title: "Address",
    description: "Chennai, Tamilnadu, India",
  },
]
        ...
        <div className="flex flex-col xl:flex-row gap-[30px]">
          <div className="xl:h-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">Feel free to contact me any time. I'll get back to you as soon as I can. </p>
                ...
                <SelectContent>
                  <SelectGroup>
                    <SelectGroup>
                      ...
                      <SelectItem value="gst">Smart Contract Development</SelectItem>
