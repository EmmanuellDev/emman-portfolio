...
const Work = () => {
  ...
  const handleSlideChange = (swiper) => {
    ...
    ssetProject(projects[currentIndex]);
  };
        ...
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          ...
          <div className="w-full xl:w-[50%]">
            <Swiper spaceBetween={30} slidesPerView={1} className="xl:h-[520px] mb-12" onSlideChange={handleSlideChange}>
              ...
              <WorkSliderBtns containerStyles="flex gap-2 absolute right-0 bottom-[calc(50%_-_22px xl:bottom-0 z-20 w-full justify-between xl:w-max xl:justify-none)]" btnStyles="bg-accent-hover hover:bg-accent-hover text-primary text-[22px] w-[44px] h-[44px] flex justify-center items-center transition-all"/>
            </Swiper>
          </div>
        </div>
      </div>
